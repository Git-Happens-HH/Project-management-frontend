...
function AppBar() {
   ...
   return(
    <div class="max-w-screen h-22 flex justify-between items-center bg-(--prokress-beige-50) px-4">
      <div id="logo-box" class="flex items-center space-x-4 text-black">
        <img class="w-60" src={ProkressTextLogo} alt="Prokress logo" />
      </div>
      { isLoggedIn && 
      <div id="button-row" class="flex space-x-4">
         <button class="bg-(--color-orange) hover:bg-(--color-green) text-white font-bold py-2 px-2 rounded-full w-10 h-10">
